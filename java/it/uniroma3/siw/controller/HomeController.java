...
public class HomeController {
    ...
    public String homepage(Model model) {
        ...
        for (Allenamento ac : primiTre) {
            ac.setTotaleRecensioni(this.allenamentoService.getTotaleRecensioni(ac));
            ac.setMediaVoti(this.allenamentoService.getMediaVoti(ac));
        }
